...
- [ ] Add a clear profile description using natural room-decor keywords.
- [ ] Create boards such as **Room Aesthetic Ideas**, **Dorm Room Decor**, **Small Bedroom Ideas**, and **Room Makeover Tips**.
- [ ] Use the Canva brief to create the first three templates.
- [ ] Produce the first 10 Pins from `pinterest-pin-ideas.csv`.
- [ ] Check every Pin’s title, description, destination URL, and board.
- [ ] Publish the first 10 Pins consistently rather than all at once.

## Learn and improve

- [ ] Review Pinterest Analytics after the initial test period.
- [ ] Record impressions, saves, outbound clicks, and outbound click rate.
- [ ] Identify the best-performing headline, visual style, aesthetic, and audience situation.
